...
# The authors used ANOVAs to test the significance of different potential 'predators' in generating a flight response among squirrels
  ...
  # So we are going to test if there is a random effect (stuff related to somewhere else in the env.) of individual on their results that was not picked up by the ANOVAs
...
#family=distrobution. Specifying distrobution (gaussian)
# ~(ap;riximated by)
